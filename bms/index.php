...
.main_div
{
    width:100%;
    height:100vh;
    background-image:linear-gradient(to right, #117A65,#117A65,#229954,#27AE60,#7DCEA0 ,#D5F5E3 );
...
.contactus:before{
    ...
    bottom: 0;
    right:0;
    background:linear-gradient(7deg,#17202A 55%, #fff 0%);
    z-index: -1;
}
.formbutton button{
...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>Basic Banking System</h2></a>
     ...
     <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            <h1 class="main_text">Basic Banking System</h1>
            <p class="big-text">World's Local Bank</p>
            <p class="big-text"> CEO KHUSH DHANDE</p>
          </div>

          <div class="col-sm-6">
            
            <img src="images/0124.png" class="img-fluid" width="560" height="345" style="margin-top:20px;">
